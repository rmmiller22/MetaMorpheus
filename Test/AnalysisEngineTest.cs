...
namespace Test
{
    ...
    public static class AnalysisEngineTests
    {
        ...
        public static void TestAnalysisEngineTests()
        {
            ...
            HashSet<PepsWSMods> value1 = new HashSet<PepsWSMods> { pep };
            ...
            PepsWSMods pep2 = new PepsWSMods(modPep2.Protein, modPep2.DigestionParams, modPep2.OneBasedStartResidueInProtein, modPep2.OneBasedEndResidueInProtein, modPep2.PeptideDescription, modPep2.MissedCleavages, modPep2.AllModsOneIsNterminus, modPep2.NumFixedMods);
            HashSet<PepsWSMods> value2 = new HashSet<PepsWSMods> { pep2 };
            ...
            PepsWSMods pep3 = new PepsWSMods(modPep3.Protein, modPep3.DigestionParams, modPep3.OneBasedStartResidueInProtein, modPep3.OneBasedEndResidueInProtein, modPep3.PeptideDescription, modPep3.MissedCleavages, modPep3.AllModsOneIsNterminus, modPep3.NumFixedMods);
            HashSet<PepsWSMods> value3 = new HashSet<PepsWSMods> { pep3 };
            ...
            MsDataFile myMsDataFile = new TestDataFile(new List<PepsWSMods> { value1.First(), value2.First(), value3.First() });
