...
namespace Test
{
    ...
    public static class MultiProteaseParsimonyTest
    {
        ...
        public static void MultiProteaseOneProteinProduceSameUniquePeptideFor2Proteases()
        {
            ...
            PepsWSMods pepA = new PepsWSMods(protein: p.ElementAt(0), digestionParams:digestionParams, oneBasedStartResidueInProtein:9, oneBasedEndResidueInProtein:11, peptideDescription:"ABC", missedCleavages:0,allModsOneIsNterminus:new Dictionary<int, ModificationWithMass>(),numFixedMods:0);
            PepsWSMods pepB = new PepsWSMods(protein: p.ElementAt(0), digestionParams: digestionParams2, oneBasedStartResidueInProtein: 9, oneBasedEndResidueInProtein: 11, peptideDescription: "ABC", missedCleavages: 0, allModsOneIsNterminus: new Dictionary<int, ModificationWithMass>(), numFixedMods: 0);
            peptideList.Add(pepA);

            peptideList.Add(pepB);
            
            // creates the initial dictionary of "peptide" and "virtual peptide" matches
            var dictionary = new Dictionary<CompactPeptideBase, List<PepsWSMods>>();
            CompactPeptide[] peptides = new CompactPeptide[peptideList.Count];

            PepsWSMods[] PWSM = new PepsWSMods[peptideList.Count];
            ...
            dictionary.Add(peptides[0], new List<PepsWSMods> { pepA, pepB });
        ...
        public static void MultiProteaseUniqueTest()
        {
            ...
            foreach (var protein in p)
            {
                foreach (var peptide in protein.Digest(digestionParams, new List<ModificationWithMass>(), new List<ModificationWithMass>()))
                {
                    ...
                    {
                        case "ABC": peptideList.Add(pep); break;
                        case "EFGABC": peptideList.Add(pep); break;
                        case "XYZ": peptideList.Add(pep); break;
                        case "GABC": peptideList.Add(pep); break;
                    }
                }
                foreach (var peptide in protein.Digest(digestionParams2, new List<ModificationWithMass>(), new List<ModificationWithMass>()))
                {
                    ...
                    {
                        case "ABC": peptideList.Add(pep); break;
                        case "-XYZ-EFG": peptideList.Add(pep); break;
                        case "-XYZ-G": peptideList.Add(pep); break;
                    }
                }
            }
            ...
            dictionary.Add(peptides[0], new HashSet<PepsWSMods> { PWSM[0], PWSM[2], PWSM[6] });
            dictionary.Add(peptides[1], new HashSet<PepsWSMods> { PWSM[1], PWSM[5], PWSM[9] });
            dictionary.Add(peptides[3], new HashSet<PepsWSMods> { PWSM[3] });
            dictionary.Add(peptides[4], new HashSet<PepsWSMods> { PWSM[4] });
            dictionary.Add(peptides[7], new HashSet<PepsWSMods> { PWSM[7] });
            dictionary.Add(peptides[8], new HashSet<PepsWSMods> { PWSM[8] });
        ...
        public static void MultiProteaseIndistiguishableTest()
        {
            ...
            foreach (var protein in p)
            {
                foreach (var peptide in protein.Digest(digestionParams, new List<ModificationWithMass>(), new List<ModificationWithMass>()))
                {
                    ...
                    {
                        case "ABC": peptideList.Add(pep); break;
                        case "EFG": peptideList.Add(pep); break;
                    }
                }
                foreach (var peptide in protein.Digest(digestionParams2, new List<ModificationWithMass>(), new List<ModificationWithMass>()))
                {
            ...
            dictionary.Add(peptides[0], new HashSet<PepsWSMods> { PWSM[0], PWSM[3] });
            dictionary.Add(peptides[1], new HashSet<PepsWSMods> { PWSM[1], PWSM[2] });
        ...
        public static void FdrFilteringPsmsTest()
        {
            ...
            dictionary.Add(peptides[0], new HashSet<PepsWSMods> { PWSM[0], PWSM[2] });
            dictionary.Add(peptides[1], new HashSet<PepsWSMods> { PWSM[1], PWSM[5] });
            dictionary.Add(peptides[3], new HashSet<PepsWSMods> { PWSM[3] });
            dictionary.Add(peptides[4], new HashSet<PepsWSMods> { PWSM[4] });
