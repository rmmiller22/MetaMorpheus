...
namespace Test
{
    ...
    public static class MyTaskTest
    {
        ...
        public static void TestEverythingRunner()
        {
            ...
            PepsWSMods pepWithSetMods1 = new PepsWSMods(digestedList[0].Protein, digestedList[0].DigestionParams, digestedList[0].OneBasedStartResidueInProtein, digestedList[0].OneBasedEndResidueInProtein, digestedList[0].PeptideDescription, digestedList[0].MissedCleavages, digestedList[0].AllModsOneIsNterminus, digestedList[0].NumFixedMods);
            PepsWSMods pepWithSetMods2 = new PepsWSMods(digestedList[1].Protein, digestedList[1].DigestionParams, digestedList[1].OneBasedStartResidueInProtein, digestedList[1].OneBasedEndResidueInProtein, digestedList[1].PeptideDescription, digestedList[1].MissedCleavages, digestedList[1].AllModsOneIsNterminus, digestedList[1].NumFixedMods);
            PepsWSMods pepWithSetMods3 = new PepsWSMods(digestedList[1].Protein, digestedList[1].DigestionParams, digestedList[1].OneBasedStartResidueInProtein, digestedList[1].OneBasedEndResidueInProtein, digestedList[1].PeptideDescription, digestedList[1].MissedCleavages, digestedList[1].AllModsOneIsNterminus, digestedList[1].NumFixedMods);
            ...
            MsDataFile myMsDataFile = new TestDataFile(new List<PepsWSMods> { pepWithSetMods1, pepWithSetMods2, pepWithSetMods3 });
        ...
        public static void TestMultipleFilesRunner()
        {
            ...
            PepsWSMods pepWithSetMods1 = new PepsWSMods(digestedList[0].Protein, digestedList[0].DigestionParams, digestedList[0].OneBasedStartResidueInProtein, digestedList[0].OneBasedEndResidueInProtein, digestedList[0].PeptideDescription, digestedList[0].MissedCleavages, digestedList[0].AllModsOneIsNterminus, digestedList[0].NumFixedMods);
            PepsWSMods pepWithSetMods2 = new PepsWSMods(digestedList[2].Protein, digestedList[2].DigestionParams, digestedList[2].OneBasedStartResidueInProtein, digestedList[2].OneBasedEndResidueInProtein, digestedList[2].PeptideDescription, digestedList[2].MissedCleavages, digestedList[2].AllModsOneIsNterminus, digestedList[2].NumFixedMods);
            PepsWSMods pepWithSetMods3 = new PepsWSMods(digestedList[2].Protein, digestedList[2].DigestionParams, digestedList[2].OneBasedStartResidueInProtein, digestedList[2].OneBasedEndResidueInProtein, digestedList[2].PeptideDescription, digestedList[2].MissedCleavages, digestedList[2].AllModsOneIsNterminus, digestedList[2].NumFixedMods);
            ...
            MsDataFile myMsDataFile1 = new TestDataFile(new List<PepsWSMods> { pepWithSetMods1, pepWithSetMods2, pepWithSetMods3 });

            string mzmlName1 = @"ok1.mzML";
            IO.MzML.MzmlMethods.CreateAndWriteMyMzmlWithCalibratedSpectra(myMsDataFile1, mzmlName1, false);

            MsDataFile myMsDataFile2 = new TestDataFile(new List<PepsWSMods> { pepWithSetMods1, pepWithSetMods2, pepWithSetMods3 });
        ...
        public static void MakeSureFdrDoesntSkip()
        {
...

            {
                ...
                PepsWSMods targetGood = new PepsWSMods(targetDigested.First().Protein, targetDigested.First().DigestionParams, targetDigested.First().OneBasedStartResidueInProtein, targetDigested.First().OneBasedEndResidueInProtein, targetDigested.First().PeptideDescription, targetDigested.First().MissedCleavages, targetDigested.First().AllModsOneIsNterminus, targetDigested.First().NumFixedMods);

                TestDataFile myMsDataFile = new TestDataFile(new List<PepsWSMods> { targetGood }, true);
        ...
        public static void MakeSureGptmdTaskMatchesExactMatches()
        {
...

            {
                ...
                ModificationMotif.TryGetMotif("T", out ModificationMotif motif);
                PepsWSMods targetGood = new PepsWSMods(targetDigested[0].Protein, targetDigested[0].DigestionParams, targetDigested[0].OneBasedStartResidueInProtein, targetDigested[0].OneBasedEndResidueInProtein, targetDigested[0].PeptideDescription, targetDigested[0].MissedCleavages, targetDigested[0].AllModsOneIsNterminus, targetDigested[0].NumFixedMods);
                PepsWSMods targetWithUnknownMod = new PepsWSMods(targetDigested[1].Protein, targetDigested[1].DigestionParams, targetDigested[1].OneBasedStartResidueInProtein, targetDigested[1].OneBasedEndResidueInProtein, targetDigested[1].PeptideDescription, targetDigested[1].MissedCleavages, targetDigested[1].AllModsOneIsNterminus, targetDigested[1].NumFixedMods);

                MsDataFile myMsDataFile = new TestDataFile(new List<PepsWSMods> { targetGood, targetWithUnknownMod }, true);
        ...
        public static void TestPeptideCount()
        {
            ...
            PepsWSMods setPep1 = new PepsWSMods(setList1[0].Protein, setList1[0].DigestionParams, setList1[0].OneBasedStartResidueInProtein, setList1[0].OneBasedEndResidueInProtein, setList1[0].PeptideDescription, setList1[0].MissedCleavages, setList1[0].AllModsOneIsNterminus, setList1[0].NumFixedMods);
            PepsWSMods setPep1_2 = new PepsWSMods(setList1[0].Protein, setList1[0].DigestionParams, setList1[0].OneBasedStartResidueInProtein, setList1[0].OneBasedEndResidueInProtein, setList1[0].PeptideDescription, setList1[0].MissedCleavages, setList1[0].AllModsOneIsNterminus, setList1[0].NumFixedMods);
            PepsWSMods setPep2 = new PepsWSMods(setList1[1].Protein, setList1[1].DigestionParams, setList1[1].OneBasedStartResidueInProtein, setList1[1].OneBasedEndResidueInProtein, setList1[1].PeptideDescription, setList1[1].MissedCleavages, setList1[1].AllModsOneIsNterminus, setList1[1].NumFixedMods);
            PepsWSMods setPep2_2 = new PepsWSMods(setList1[1].Protein, setList1[1].DigestionParams, setList1[1].OneBasedStartResidueInProtein, setList1[1].OneBasedEndResidueInProtein, setList1[1].PeptideDescription, setList1[1].MissedCleavages, setList1[1].AllModsOneIsNterminus, setList1[1].NumFixedMods);
            PepsWSMods setPep3 = new PepsWSMods(setList1[2].Protein, setList1[2].DigestionParams, setList1[2].OneBasedStartResidueInProtein, setList1[2].OneBasedEndResidueInProtein, setList1[2].PeptideDescription, setList1[2].MissedCleavages, setList1[2].AllModsOneIsNterminus, setList1[2].NumFixedMods);
            PepsWSMods setPep4 = new PepsWSMods(setList1[3].Protein, setList1[3].DigestionParams, setList1[3].OneBasedStartResidueInProtein, setList1[3].OneBasedEndResidueInProtein, setList1[3].PeptideDescription, setList1[3].MissedCleavages, setList1[3].AllModsOneIsNterminus, setList1[3].NumFixedMods);
            //Finally Write MZML file
            MsDataFile myMsDataFile = new TestDataFile(new List<PepsWSMods> { setPep1, setPep2, setPep3, setPep4, setPep1_2, setPep2_2 });
