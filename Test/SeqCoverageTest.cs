...
namespace Test
{
    ...
    public static class SeqCoverageTest
    {
        ...
        public static void TryFailSequenceCoverage()
        {
            ...
            var pwsm1 = new PepsWSMods(protein: prot1, digestionParams: digestionParams, oneBasedStartResidueInProtein: 1, oneBasedEndResidueInProtein: 3, peptideDescription: "", missedCleavages: 0, allModsOneIsNterminus: modsFor1, numFixedMods: 0);
            var pwsm2 = new PepsWSMods(protein: prot1, digestionParams: digestionParams, oneBasedStartResidueInProtein: 4, oneBasedEndResidueInProtein: 6, peptideDescription: "", missedCleavages: 0, allModsOneIsNterminus: modsFor2, numFixedMods: 0);
            var pwsm3 = new PepsWSMods(protein: prot1, digestionParams: digestionParams, oneBasedStartResidueInProtein: 1, oneBasedEndResidueInProtein: 6, peptideDescription: "", missedCleavages: 0, allModsOneIsNterminus: modsFor3, numFixedMods: 0);

            HashSet<PepsWSMods> peptides = new HashSet<PepsWSMods>
            {
                pwsm1,
                pwsm2,
                pwsm3,
            ...
            {
                { pwsm1.CompactPeptide(TerminusType.None), new HashSet<PepsWSMods>{ pwsm1 } },
                { pwsm2.CompactPeptide(TerminusType.None), new HashSet<PepsWSMods>{ pwsm2 } },
                { pwsm3.CompactPeptide(TerminusType.None), new HashSet<PepsWSMods>{ pwsm3 } },
            };
