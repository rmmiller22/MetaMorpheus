...
namespace Test
{
    internal class TestDataFile : MsDataFile
    {
        ...
        public TestDataFile(List<PepsWSMods> pepWithSetModss, bool additionalMasses = false) : base(pepWithSetModss.Count * 2, new SourceFile(@"no nativeID format", "mzML format", null, "SHA-1", @"C:\fake.mzML", null))
        {
        ...
        public TestDataFile(PepsWSMods pepWithSetMods) : base(2, new SourceFile(@"no nativeID format", "mzML format", null, "SHA-1", @"C:\fake.mzML", null))
        {
        ...
        public TestDataFile(PepsWSMods pepWithSetMods, string v) : base(2, new SourceFile(null, null, null, null, null))
        {
        ...
        public TestDataFile(PepsWSMods pepWithSetMods, int charge, double intensity, double rt) : base(2, new SourceFile(null, null, null, null, null))
        {
