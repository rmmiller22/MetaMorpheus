...
namespace Test
{
    ...
    public static class TestPsm
    {
        ...
        public static void TestPsmHeader()
        {
            ...
            PepsWSMods pepWSMods = new PepsWSMods(pepWithSetMods.Protein, pepWithSetMods.DigestionParams, pepWithSetMods.OneBasedStartResidueInProtein, pepWithSetMods.OneBasedEndResidueInProtein, pepWithSetMods.PeptideDescription, pepWithSetMods.MissedCleavages, pepWithSetMods.AllModsOneIsNterminus, pepWithSetMods.NumFixedMods);
            MsDataFile myMsDataFile = new TestDataFile(pepWSMods, "quadratic");
            ...
            {
                { pepWithSetMods.CompactPeptide(TerminusType.None), new HashSet<PepsWSMods>{ pepWSMods } }
            };
