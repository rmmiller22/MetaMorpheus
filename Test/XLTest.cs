...
namespace Test
{
    ...
    public static class XLTest
    {
        ...
        static List<PepsWSMods> digestedList { get; set; }
        ...
        private static void Generate()
        {
            ...
            digestedList = new List<PepsWSMods>();
            foreach (var item in proteinList)
            {
                ...
                {
                    PepsWSMods pepWSMods = new PepsWSMods(pep.Protein, pep.DigestionParams, pep.OneBasedStartResidueInProtein, pep.OneBasedEndResidueInProtein, pep.PeptideDescription, pep.MissedCleavages, pep.AllModsOneIsNterminus, pep.NumFixedMods);
                    digestedList.Add(pepWSMods);
                }               
            }
        ...
        public static void XlTest_BSA_DSSO()
        {
            ...
            var compactPeptideToProteinPeptideMatch = new Dictionary<CompactPeptideBase, HashSet<PepsWSMods>>();
        ...
        public static void XlTest_DiffCrosslinkSites()
        {
            ...
            //Generate digested peptide lists.
            List<PepsWSMods> digestedList = new List<PepsWSMods>();
            foreach (var item in proteinList)
            {
                var digested = item.Digest(commonParameters.DigestionParams, fixedModifications, variableModifications).ToList();
                foreach (var pep in digested)
