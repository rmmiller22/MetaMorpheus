...
namespace Test
{
    ...
    public static class GptmdPrunedDbTests
    {
        ...
        public static void TestUserModSelectionInPrunedDB()
        {
            ...
            PepsWSMods pepWithSetMods4 = new PepsWSMods(digestedList[3].Protein, digestedList[3].DigestionParams, digestedList[3].OneBasedStartResidueInProtein, digestedList[3].OneBasedEndResidueInProtein, digestedList[3].PeptideDescription, digestedList[3].MissedCleavages, digestedList[3].AllModsOneIsNterminus, digestedList[3].NumFixedMods);
            PepsWSMods pepWithSetMods5 = new PepsWSMods(digestedList[4].Protein, digestedList[4].DigestionParams, digestedList[4].OneBasedStartResidueInProtein, digestedList[4].OneBasedEndResidueInProtein, digestedList[4].PeptideDescription, digestedList[4].MissedCleavages, digestedList[4].AllModsOneIsNterminus, digestedList[4].NumFixedMods);
